    ...
    <section className="my" id="my">
      ...
      <div className="my__container">
        <div className="my__content">
          ...
          Я работаю в Центральном институте авиационного моторостроения им.&nbsp;П.И.&nbsp;Баранова (г. Москва). Закончил Российский государственный университет нефти и&nbsp;газа имени И.М.&nbsp;Губкина и&nbsp;Национальный исследовательский университет "МЭИ". Защитил кандидатскую диссертацию. Люблю горные лыжи, ролики и&nbsp;быструю езду на&nbsp;спортивных автомобилях. Благодаря учебному курсу приобрел опыт реализации классных проектов в&nbsp;области HTML-, CSS- и&nbsp;JS-разработки.
          </p>
          <a
