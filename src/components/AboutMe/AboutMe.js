    ...
    <section className="my" id="my">
      ...
      <div className="my__container">
        <div className="my__content">
          ...
          Я работаю в научном подразделении Центрального института авиационного моторостроения им.&nbsp;П.И.&nbsp;Баранова (г. Москва). Занимаюсь математическим моделированием рабочих процессов в&nbsp;теплоэнергетических установках. По&nbsp;совместительству являюсь заместителем академика-секретаря секции «Авиакосмическая» Российской инженерной академии. Увлекаюсь горными лыжами, роликами, люблю быструю езду на&nbsp;спортивных автомобилях. Благодаря учебному курсу приобрел опыт реализации проектов в&nbsp;области HTML-, CSS- и&nbsp;JS-разработки.          </p>
          <a
