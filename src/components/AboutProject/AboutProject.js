      ...
      <div className="project__container">
        ...
        <div className="project__content">
          <div className="project__info">
            <h3 className="project__info-header">Дипломный проект включал 5 этапов</h3>
          ...
          <div className="project__info">
            <h3 className="project__info-header">На выполнение диплома ушло 5 недель</h3>
            <p className="project__info-description">
        ...
        <div className="project__time">
          <h3 className="project__time-header project__time-header_green">1 неделя</h3>
